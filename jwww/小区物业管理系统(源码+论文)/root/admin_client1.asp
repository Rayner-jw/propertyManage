...
sub SaveEdit()
	...
	cmd = "Update baseinfo set 户主名称='"&stname&"',房屋号='"&stPassword&"',备注='"&stAbout&"',迁入日期='"&stindate&"',房型='"&stroomtype&"',联系电话='"&StDepartment&"',楼宇名称='"&StChairman&"',楼层='"&Stmanager&"',单元='"&StContect&"' Where 住户编号 = "&id&""
	response.write cmd
...
Sub del()
	...
	dim del	
	Data.Execute("delete from baseinfo where 住户编号 = "&id&"")
...
set rs=Data.Execute("Select * from baseinfo order by 住户编号 desc")
...
Id=Session("Belong")
End If
set RS = Data.Execute("select * from baseinfo where 住户编号 = "& id&"")
Edit_News = rs(6)
%>
<table width="97%" border="0" align="center" cellpadding="3" cellspacing="1" class="tableBorder">
<form action="admin_client.asp?action=SaveEdit" method="post" id="form_edit" name="form_edit" onsubmit="javascript:submits();">
  ...
  <tr>
    ...
    <td colspan="2" class="table"><input name="StName2" type="text" class="lostfocus" onFocus='this.className="getfocus";this.gf="1"' onBlur='this.className="lostfocus";this.gf="0"' onMouseOver='this.className="getfocus"' onMouseOut='if (this.gf=="0") this.className="lostfocus"' size="40" gf="0"></td>
  </tr>
  <tr>
    <td width="18%" height="22" class="table">&nbsp;联系电话</td>
    <td colspan="2" class="table"><input name="StDepartment" type="text" class="lostfocus" onfocus='this.className="getfocus";this.gf="1"' onblur='this.className="lostfocus";this.gf="0"' onmouseover='this.className="getfocus"' onmouseout='if (this.gf=="0") this.className="lostfocus"'size="40" gf="0"></td>
  </tr>
  <tr valign="top">
    <td height="22" class="table">&nbsp;楼宇名称</td>
    <td colspan="2" class="table"><input name="StChairman" type="text" class="lostfocus" onfocus='this.className="getfocus";this.gf="1"' onblur='this.className="lostfocus";this.gf="0"' onmouseover='this.className="getfocus"' onmouseout='if (this.gf=="0") this.className="lostfocus"' size="40" gf="0"></td>
  </tr>
  <tr valign="top">
    <td height="22" class="table">&nbsp;楼层</td>
    <td colspan="2" valign="top" class="table"><input name="Stmanager" type="text" class="lostfocus" onfocus='this.className="getfocus";this.gf="1"' onblur='this.className="lostfocus";this.gf="0"' onmouseover='this.className="getfocus"' onmouseout='if (this.gf=="0") this.className="lostfocus"' size="40" gf="0">    </td>
  </tr>
    <tr>
    <td width="18%" height="22" class="table">&nbsp;房屋号</td>
    <td colspan="2" class="table"><input name="StPassword" type="text" class="lostfocus" onfocus='this.className="getfocus";this.gf="1"' onblur='this.className="lostfocus";this.gf="0"' onmouseover='this.className="getfocus"' onmouseout='if (this.gf=="0") this.className="lostfocus"'size="40" gf="0"></td>
  </tr>
  <tr valign="top">
    ...
    <td colspan="2" class="table"><input name="indate" type="text" class="lostfocus" id="indate" onfocus='this.className="getfocus";this.gf="1"' onblur='this.className="lostfocus";this.gf="0"' onmouseover='this.className="getfocus"' onmouseout='if (this.gf=="0") this.className="lostfocus"'size="40" gf="0"></td>
  </tr>
    <tr>
    <td width="18%" height="22" class="table">&nbsp;房型</td>
    <td colspan="2" class="table"><input name="roomtype" type="text" class="lostfocus" id="roomtype" onfocus='this.className="getfocus";this.gf="1"' onblur='this.className="lostfocus";this.gf="0"' onmouseover='this.className="getfocus"' onmouseout='if (this.gf=="0") this.className="lostfocus"' size="40" gf="0">
      <input name="id" type="hidden" class="lostfocus" id="id" onfocus='this.className="getfocus";this.gf="1"' onblur='this.className="lostfocus";this.gf="0"' onmouseover='this.className="getfocus"' onmouseout='if (this.gf=="0") this.className="lostfocus"' size="40" gf="0"></td>
	
  </tr>
  <tr valign="top">
    <td class="table"><p align="left">&nbsp;说明</p></td>
    <td width="279" class="table"><input name="edit" id="edit" type="hidden" ></input>
